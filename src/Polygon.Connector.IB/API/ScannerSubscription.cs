...
namespace IBApi
{
     ...
     */
    internal class ScannerSubscription
    {
        /**
         ...
         * @brief Filters out Contracts with a SnP rating below this value.
         */
        private string spRatingAbove;

        /**
         * @var string spRatingBelow
         * @brief Filters out Contracts with a SnP rating above this value.
         */
