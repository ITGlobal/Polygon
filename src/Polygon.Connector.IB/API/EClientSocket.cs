    ...
    internal class EClientSocket
    {
        ...
        */
        ...
        public bool reqContractDetails(int reqId, Contract contract)
        {
            ...
            return Send(reqId, paramsList, EClientErrors.FAIL_SEND_REQCONTRACT);
        }
        ...
        protected bool Send(int reqId, List<byte> paramsList, CodeMsgPair error)
        {
            try
            {
                lock (this)
