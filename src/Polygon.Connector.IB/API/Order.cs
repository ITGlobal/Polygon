...
namespace IBApi
{
    ...
    internal partial class Order
    {
         ...
         * The reference price is used for VOL orders to compute the limit price sent to an exchange (whether or not Continuous UpdateAsync is selected), and for price range monitoring.
         */
